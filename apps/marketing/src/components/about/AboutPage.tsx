    ...
    <div className="min-h-screen bg-foundation-alternate">
      ...
      <section className="bg-neutral-primary border-y border-neutral-tertiary-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {howItWorks.map((item) => (
              <div key={item.step} className="flex gap-5 p-6 rounded-2xl bg-neutral-secondary border border-neutral-tertiary-border">
                <span className="text-4xl font-paytone text-brand-pixsee-secondary/30 leading-none shrink-0">
                  {item.step}
                </span>
                <div>
                  <h3 className="font-semibold text-neutral-primary-text mb-2">{item.title}</h3>
                  <p className="text-sm text-neutral-secondary-text leading-relaxed">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {values.map((v) => (
            <div key={v.title} className="p-6 rounded-2xl bg-neutral-primary border border-neutral-tertiary-border hover:border-brand-pixsee-secondary/40 transition-colors">
              ...
              <p className="text-sm text-neutral-secondary-text leading-relaxed">{v.description}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-neutral-primary border-t border-neutral-tertiary-border">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {team.map((member) => (
              <div key={member.name} className="group relative rounded-2xl overflow-hidden aspect-3/4 cursor-default">

    ...
    <section className="relative w-full bg-foundation-primary py-20 px-4">
      <div className="max-w-[90rem] mx-auto">
        <div
          ...
          className={`relative overflow-hidden rounded-3xl lg:rounded-[2.5rem] ${containerResult.animationClass}`}
          style={{ transitionDelay: "0s" }}
        >
          <div className="absolute inset-0 bg-gradient-to-r from-brand-action via-blue-600 to-brand-pixsee-secondary"></div>

          <div className="relative z-10 flex flex-col items-center justify-center gap-8 px-6 lg:px-12 py-16 lg:py-24 text-center">
            <div
              ref={titleResult.ref}
              className={`${titleResult.animationClass}`}
              style={{ transitionDelay: "0.1s" }}
            >
              <h2 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-white max-w-4xl mx-auto">
            ...
            >
              <Button
                asChild
                className="bg-brand-pixsee-secondary hover:bg-brand-pixsee-hover text-white rounded-full px-8 py-6 font-semibold text-base shadow-lg"
              >
              ...
              <Button
                asChild
                className="bg-white hover:bg-white/90 text-brand-action rounded-full px-8 py-6 font-semibold text-base shadow-lg"
              >
